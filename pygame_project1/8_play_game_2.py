...
fail_font = pygame.font.Font(None, 80)
#총 시간
total_time = 10
...
# 2. 이벤트 처리 (키보드, 마우스 등)
    for event in pygame.event.get():     #사용자가 마우스를 움직인다던지, 키보드를 입력한다던지 하는 이벤트를 계속해서 받겠다는 뜻. 키보드르 누르면 무기를 발사한다던지 등등
        ...
        to_enemy_x = (character_x_pos - enemy_x_pos) / 1000
        to_enemy_y = (character_y_pos - enemy_y_pos) / 1000
        print(to_enemy_y)
...
#5. 화면에 그리기
    ...
    if  faile == False:
       ...
       winner = ending_font.render("Faile!!", True, (255,255,255))

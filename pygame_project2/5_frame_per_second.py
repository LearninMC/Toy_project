...
while running:
    dt = clock.tick(10)     #게임화면의 초당 프레임 수, dt대신 아무이름이나 써도 먹힘. , clock은 pygame의 time에서 Clock클래스 임. 여기서 정의된 함수인 tick을 쓴것임. 근데 그 값을 변수에 지정을 했는데, 프레임이 먹히네 신기..

#케릭터가 1초에 100만큼 이동을해야함
#10fps : 1초 동안에 10번 동작 -> 한번에 10만큼 이동해야 100이동
#20fps : 1초 동안에 20번 동작 -> 한번에 5만큼 이동해야 100이동
#즉 fps가 다르디고 속도가 다르면 안됨. 해결책은 포지션에 dt만큼 곱해줌
